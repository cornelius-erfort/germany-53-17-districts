...
write_dta(results_long, "election-results-53-17.dta")
...
ggplot() +
  ...
  scale_fill_gradient(low = "dark red", high = "dark green", na.value = "dark green") +
    ...
    ggsave("coverage_map_1953-2017.png", device = png, width = 1500*4.5/5, height = 1500, res = 300, limitsize = F)
