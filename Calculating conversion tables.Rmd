...
ggplot() +
  ...
  scale_fill_gradient(low = "dark red", high = "dark green", na.value = "dark green") +
    ggsave("plots/coverage_map_1953-2017.pdf", device = cairo_pdf, width = 4.5, height = 5) +
    ggsave("plots/coverage_map_1953-2017.png", device = png, width = 1500*4.5/5, height = 1500, res = 300, limitsize = F)
